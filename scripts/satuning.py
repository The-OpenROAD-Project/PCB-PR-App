...
lamrate = np.linspace(0.1,0.25, 5)
temperatures = np.linspace(0.88, 0.95, 5)
lambda_schedules = np.linspace(0.95, 0.98, 5)
...
def SA(step_length, params):
    pass

def tuning(annealer, window):
    pass
